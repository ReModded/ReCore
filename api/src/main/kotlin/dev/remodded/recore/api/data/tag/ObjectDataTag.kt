...
inline fun <reified T: Any> ObjectDataTag.getValue(key: String) = getValue(key, T::class.java)
inline fun <reified T: Any> ObjectDataTag.tryGetValue(key: String) = tryGetValue(key, T::class.java)
